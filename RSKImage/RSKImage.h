...
//! Project version number for RSKImage.
FOUNDATION_EXPORT double RSKImageVersionNumber;

//! Project version string for RSKImage.
FOUNDATION_EXPORT const unsigned char RSKImageVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <RSKImage/PublicHeader.h>
